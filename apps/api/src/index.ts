...
import publicProposalRoutes from "./routes/public-proposals.routes";
import publicLandingRoutes from "./routes/public-landing.routes";
import publicCmsRoutes from "./routes/public-cms.routes";
...
import adminManagedServicesRoutes from "./routes/admin-managed-services.routes";
import adminCreditRulesRoutes from "./routes/admin-credit-rules.routes";
import adminGoogleMonitorRoutes from "./routes/admin-google-monitor.routes";
import adminAiPromptsRoutes from "./routes/admin-ai-prompts.routes";
import adminLanguagesRoutes from "./routes/admin-languages.routes";
import adminPartnerOverviewRoutes from "./routes/admin-partner-overview.routes";
...
app.use("/api/v1/admin/managed-services", adminManagedServicesRoutes);
app.use("/api/v1/admin/credit-rules", adminCreditRulesRoutes);
app.use("/api/v1/admin/google-monitor", adminGoogleMonitorRoutes);
app.use("/api/v1/admin/currency-rates", adminCurrencyRatesRoutes);
app.use("/api/v1/admin/ai-prompts", adminAiPromptsRoutes);
app.use("/api/v1/admin/partner-overview", adminPartnerOverviewRoutes);
...
app.use("/api/v1/currency-settings", currencySettingsRoutes);
...
app.use("/api/v1/public/landing", publicLandingRoutes);
app.use("/api/v1/public/cms", publicCmsRoutes);
app.use("/api/v1/public", publicProposalRoutes);
