  ...
  return (
    <DashboardShell user={user} features={features} signOut={signOut}>
      ...
      <section className="mb-6 rounded-md border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              {connection?.connected
                ...
                : "Not connected yet. Use OAuth when configured, or save a refresh token from Google Cloud for manual setup."}
            </p>
        ...
        {!connection?.connected && (
          <form onSubmit={saveToken} className="mt-4 grid gap-3 border-t border-slate-100 pt-4 lg:grid-cols-[1fr,220px,auto]">
            <input
              value={refreshToken}
