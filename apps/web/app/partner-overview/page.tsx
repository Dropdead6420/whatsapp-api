...
import { partnersToCsv } from "../../src/lib/partnersCsv";
    ...
    <DashboardShell user={user} features={features} signOut={signOut}>
      <div className="mb-6 flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="flex-none rounded-md border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-100 disabled:opacity-50"
        >
          Export Report
        </button>
      </div>
