...
export const APP_NAV_SECTIONS: AppNavSection[] = [
  ...
  },
  {
    label: "Local SEO (GMB)",
    items: [
      { href: "/gmb-dashboard", label: "Home", icon: LayoutGrid, roles: BUSINESS_ROLES },
      { href: "/gmb-reputation", label: "Reputation", icon: Star, roles: BUSINESS_ROLES },
      { href: "/gmb-ranking", label: "Rankings", icon: Globe, roles: BUSINESS_ROLES },
      // Content hub = GBP posts + the AI authoring tools (Descriptions/Images/Advisor) linked from that page.
      { href: "/gmb", label: "Content", icon: Calendar, roles: BUSINESS_ROLES, activeRoutes: ["/gmb", "/gmb-descriptions", "/gmb-images", "/gmb-advisor"] },
      ...
      { href: "/gmb-citations", label: "Citations", icon: MapPin, roles: BUSINESS_ROLES },
      { href: "/managed-services", label: "Managed", icon: Zap, roles: BUSINESS_ROLES },
      { href: "/gmb-locations", label: "Profile", icon: Building2, roles: BUSINESS_ROLES },
    ],
  },
  {
    label: "Operations",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/ai-routing", label: "AI Routing", icon: Workflow, roles: ["SUPER_ADMIN"] },
